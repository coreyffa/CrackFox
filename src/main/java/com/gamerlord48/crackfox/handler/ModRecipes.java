...
public class ModRecipes {
    ...
    public static void addRecipes()
    {
        ...
        GameRegistry.addRecipe(new ItemStack(ModBlocks.crackFoxBlock), new Object[] { "XXX", "XYX", "XXX", 'X', Blocks.planks, 'Y', Blocks.torch });

        GameRegistry.addRecipe(new ItemStack(ModItems.chromiumAxe), new Object[] { " XX", " YX", " Y ", 'X', ModItems.chromiumIngot, 'Y', Items.stick });

        GameRegistry.addRecipe(new ItemStack(ModItems.chromiumAxe), new Object[] { "XX ", "XY ", " Y ", 'X', ModItems.chromiumIngot, 'Y', Items.stick });

        GameRegistry.addRecipe(new ItemStack(ModItems.chromiumPickaxe), new Object[] { "xxx", " o ", " o ", 'x', ModItems.chromiumIngot, 'o', Items.stick });

        GameRegistry.addRecipe(new ItemStack(ModItems.chromiumSpade), new Object[] { " x ", " o ", " o ", 'x', ModItems.chromiumIngot, 'o', Items.stick });

        GameRegistry.addRecipe(new ItemStack(ModItems.chromiumSword), new Object[] { " x ", " x ", " o ", 'x', ModItems.chromiumIngot, 'o', Items.stick });

        GameRegistry.addRecipe(new ItemStack(ModItems.chromiumIngot), new Object[] { "xxx", "xxx", "xxx", 'x', ModItems.chromiumNugget });
